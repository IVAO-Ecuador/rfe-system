...
export const LoginSection = ({ onChangeSession }) => {
	...
	return (
		<div className="p-12 rounded-2xl text-center bg-purple-login w-[580px] h-[auto] login-bg relative">
			...
			<a href="https://login.ivao.aero/index.php?url=http://rfo.ec.ivao.aero" className="w-full block text-white py-5 bg-purple-button rounded-xl button-login relative pl-20 mb-6">{translations[selectedLanguage].login_button}</a>
