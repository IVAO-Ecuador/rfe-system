  ...
  return (
    <div className='mb-10'>
      ...
      {!statistics ? (
          ...
          <p className='w-1/3 bg-green p-3 text-center rounded-md text-white'>{translations[selectedLanguage].rfo_available} <span>{counts.Libre}</span></p>
          <p className='w-1/3 bg-yellow p-3 text-center rounded-md text-white'>{translations[selectedLanguage].rfo_waitingConfirmation} <span>{counts.Reservado}</span></p>
          <p className='w-1/3 bg-red p-3 text-center rounded-md text-white'>{translations[selectedLanguage].rfo_booked} <span>{counts.Confirmado}</span></p>
        </div>
			)}
